...
def options():
    ...
    parser.add_argument('--data_path', default='data', type=str) # Remove fixed directory
    ...
    parser.add_argument('--dataset', choices=['CIFAR10', 'CIFAR100', 'TinyImageNet'], default='CIFAR10', 
            help='choose dataset') # add Tiny-Imagenet
    parser.add_argument('--num_classes', type=int, default=10) # add        
